...
- **CI/CD & AI QA Automation:** Настроил автоматизированные CI/CD-пайплайны и автоматизировал QA-процессы с помощью AI для генерации тестовых сценариев и верификации на staging, ускорив релизные циклы и раннее выявление регрессий.
...
- **Стек:** Python (Asyncio, FastAPI), Golang, MCP, Qdrant, OpenAI / Claude APIs, LangGraph, Ragas, CI/CD, Docker, Kubernetes.
...
- **AI-архитектура для B2B и стартапов:** В роли Fractional Architect проектировал системную архитектуру генеративного ИИ, подбор моделей и интеграцию LLM в существующие бэкенды для фаундеров и CTO 6+ технологических компаний (FinTech, EdTech, LegalTech).
