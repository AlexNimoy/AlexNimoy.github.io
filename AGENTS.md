...
| Skill                                         | Purpose                                      |
| --------------------------------------------- | -------------------------------------------- |
| `.agents/skills/humanizer/`                   | Remove AI-generated writing patterns (source: https://github.com/blader/humanizer) |

To update a skill, re-clone its repository into the corresponding subdirectory.
